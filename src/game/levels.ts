...
export function createLevel5(): LevelConfig {
  ...
  const enemies: Enemy[] = [
    ...
    // LEVEL 5 GIANT SLIME BOSS
    {
      id: 'l5-boss-slime',
      type: 'giant_slime_boss',
      name: 'KING SLIME • PENGUASA LENDIR',
      x: 1850,
      y: 540,
      vx: 0,
      vy: 0,
  ...
  return {
    levelNumber: 5,
    title: 'LEVEL 5: ARENA KING SLIME',
    subtitle: 'Pertarungan Sengit Melawan Raja Lendir Raksasa',
    description: 'Waspada! Raja Lendir raksasa (King Slime) bangkit menjaga gerbang benteng kuno. Kalahkan sang bos untuk membuka jalan ke portal terakhir!',
    mapWidth,
    mapHeight,
    playerStartX: 100,
    playerStartY: 550,
